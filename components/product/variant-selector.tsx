        ...
        {option.values.map((value) => {
          ...
          return (
            <button
              ...
              className={clsx('flex min-w-[48px] items-center justify-center rounded-full border px-2 py-1 text-sm border-neutral-800 bg-neutral-900', {
                ...
                'relative z-10 cursor-not-allowed overflow-hidden ring-1 before:absolute before:inset-x-0 before:-z-10 before:h-px before:-rotate-45 before:transition-transform bg-neutral-900 text-neutral-400 ring-neutral-700 before:bg-neutral-700': !isAvailableForSale,
              })}
            >
              {value}
            </button>
